/* 5 - Faça um programa que recebe 
um número inteiro e mostre o 
...
class AnteSuce {
  ...
  void exibir() {
    var antecessor = antes();
    var sucessor = depois();

    // exibe o resultado da função
    print(" ");
    print("~-" * 30);
    print("O antecessor do numero $numero é $antecessor");
    print(".°" * 30);
    print("O sucessor do numero $numero é $sucessor");
    print("~-" * 30);
  }
}
...
void main() {
  while (true) {
    ...
    AnteSuce antesuce = AnteSuce(numero: numero);
