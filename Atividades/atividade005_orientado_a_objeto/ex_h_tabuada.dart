/* 8 - Faça um programa que receba um número inteiro. 
O programa deverá imprimir tabuada 
de multiplicação deste número. */
...
void main() {
  while (true) {
    ...
    int numero = validacao.lerInt("Entre com um número inteir aleatorio: ");
